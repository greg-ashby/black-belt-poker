...
class HandTest {
	...
	return Stream.of(
		...
		Arguments.of(
			new Hand(HandRank.FLUSH,
				List.of(CardRank.ACE, CardRank.KING, CardRank.QUEEN, CardRank.JACK, CardRank.TEN)),
		...
		Arguments.of(
			new Hand(HandRank.HIGH_CARD,
				List.of(CardRank.ACE, CardRank.KING, CardRank.QUEEN, CardRank.JACK, CardRank.TEN)),
			new Hand(HandRank.HIGH_CARD,
				List.of(CardRank.ACE, CardRank.KING, CardRank.QUEEN, CardRank.JACK, CardRank.NINE)),
  ...
  void testCompareTo(Hand hand1, Hand hand2, int expected) {
